...
set CLASSPATH=%APP_HOME%\lib\service-1.0.0.jar;%APP_HOME%\lib\lib-module-1.0.0.jar;%APP_HOME%\lib\groovy-2.4.10.jar

@rem Execute service
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVICE_OPTS%  -classpath "%CLASSPATH%" service.Greeter %CMD_LINE_ARGS%
